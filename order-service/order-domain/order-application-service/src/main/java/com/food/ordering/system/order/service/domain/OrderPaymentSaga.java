...
public class OrderPaymentSaga implements SagaStep<PaymentResponse> {
    ...
    public OrderPaymentSaga(OrderSagaHelper orderSagaHelper,
                            ...
                            PaymentOutboxHelper paymentOutboxHelper, ApprovalOutboxHelper approvalOutboxHelper, OrderDataMapper orderDataMapper, OrderRepository orderRepository) {
    ...
    public void process(PaymentResponse paymentResponse) {
        ...
        //Create new record for approval outbox.
    ...
    public void rollback(PaymentResponse paymentResponse) {
        ...
        // Prevent if already processing by other thread.
        Optional<OrderPaymentOutboxMessage> orderPaymentOutboxMessageResponse =
                paymentOutboxHelper.getPaymentOutboxMessageBySagaIdAndSagaStatus(
                        UUID.fromString(paymentResponse.getSagaId()),
        ...
        //update rollback for payment outbox table.
